<?php
  /**
		This page is intentionally empty. If you want to theme your profile page you
		could choose several ways to do it.
		
		1. Add blocks and use user/* as a path
		2. Use context module (recommended)
		3. Add code to this page. I recommend you to implement your own
		   hook_preprocess_profile_page() function to define variables
		   and use them here.
		   
		If you decide to use the third option, don't override this file, copy it
		to your theme and clear the cache
	*/
?>
...
<head>
  ...
  <link type="text/css" rel="stylesheet" media="all" href="/scd6/sites/all/themes/salmonchase_v1/css/profile.css?j" />
    ...
    <div id="main-wrapper"><div id="main" class="clearfix<?php if ($primary_links || $navigation) { print ' with-navigation'; } ?>">
      ...
      <div id="content" class="column"><div class="section">
        ...
        <div id="content-area">
         ...
         <?php 
/*
	// Print User menu if user is logged in 	

	if (user_is_logged_in()): 
    
    $profile_content_type = 'profile';
    // Load the content profile of the current user.
...
*/	
	?>
         ...
         <?php 
			...
			$userdid = arg(1);
			// Pass the uid to the content_profile_load() function to get access to the node id for the profile for that user.
			$profile_node = content_profile_load('profile', $userdid);
			// dvm($profile_node);
		 ?>
        
          <?php print $content; ?>
          <div class="profile-wrapper">
                <h1 class="name"><?php print $profile_node->field_name[0]['value'];?></h1>
                
                <div class="contain">
        
                    <div class="profile-meta left">
                        <p class="jobtitle"><?php print $profile_node->field_job_title[0]['value'];?></p>
                        <p class="location"><?php print $profile_node->field_location[0]['value'];?></p>
                    </div>
 ...
 <img src="http://dygz78ls5cy51.cloudfront.net/ff6ac53750c64952bcdd5a03bf271efd" class="bgmaximage" /> 
</body>
</html>
